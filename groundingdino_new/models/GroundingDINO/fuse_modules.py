...
from .cl_lora import LoraLinear # db
...
class BiMultiHeadAttention(nn.Module):
    def __init__(self, v_dim, l_dim, embed_dim, num_heads, dropout=0.1, cfg=None, use_moe_lora = False): # db
        ...
        self.v_dim = v_dim
        self.l_dim = l_dim
        self.use_moe_lora = use_moe_lora # db
...
class BiAttentionBlock(nn.Module):
    def __init__(
        ...
        self.attn = BiMultiHeadAttention(
            v_dim=v_dim, l_dim=l_dim, embed_dim=embed_dim, num_heads=num_heads, dropout=dropout, use_moe_lora=self.use_moe_lora # db
        )
