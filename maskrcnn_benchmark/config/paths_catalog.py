...
class DatasetCatalog(object):
    DATASETS = {
        ...
        "coco_grounding_train_for_obj365": {
            "img_dir": "/media/DISK4TB/personal/Doubei/data_test_241/coco2017/images/train2017",
            "ann_file": "/media/DISK4TB/personal/Doubei/data_test_241/coco2017/annotations/instances_train2017.json",
            "is_train": True,
            "exclude_crowd": True,
        },
        ...
        # db odinw
        # ... (在 DATASETS 字典中添加以下内容) ...

        # ================== ODinW 13 Tasks (Few-Shot) ==================
        
        # 1. AerialMaritimeDrone
        "Aerial_train_vision_query": {
        # "Aerial_train": {
        ...
        "Aerial_val": {
            "img_dir": "odinw/AerialMaritimeDrone/large/valid", # 或 valid
            "ann_file": "odinw/AerialMaritimeDrone/large/valid/annotations_without_background.json"
        },

        # 2. Aquarium
        "Aquarium_train": {
            "img_dir": "odinw/Aquarium/Aquarium_Combined.v2-raw-1024.coco/train",
            "ann_file": "odinw/Aquarium/Aquarium_Combined.v2-raw-1024.coco/train/fewshot_train_shot5_seed3.json",
            "is_train": True
        },
        # ... (Val set if needed)
        "Aquarium_val": {
            "img_dir": "odinw/Aquarium/Aquarium_Combined.v2-raw-1024.coco/valid", # 注意: Aquarium 通常用 test
            "ann_file": "odinw/Aquarium/Aquarium_Combined.v2-raw-1024.coco/valid/annotations_without_background.json",
        },
        ...
        "Rabbit_val": {
            "img_dir": "odinw/CottontailRabbits/valid", # 注意: Rabbits 通常用 valid
        ...
        "Mushroom_train": {
            "img_dir": "odinw/NorthAmericaMushrooms/North_American_Mushrooms.v1-416x416.coco/train",
            "ann_file": "odinw/NorthAmericaMushrooms/North_American_Mushrooms.v1-416x416.coco/train/fewshot_train_shot5_seed3.json",
            "is_train": True
        },
        ...
        # 8. Pistols
        "Pistol_train": {
            "img_dir": "odinw/pistols/export/train",
            "ann_file": "odinw/pistols/export/train/fewshot_train_shot5_seed3.json",
            "is_train": True
        },
    ...
    def get(name):
        ...
        if name.endswith('_bg'):
            ...
            # db
            # ... (在 elif "_caption" in name 之前添加) ...

            # [NEW] 处理 ODinW 训练集
            elif name in [
                "Aerial_train", "Aquarium_train", "Rabbit_train", "EgoHands_train", 
                "Mushroom_train", "Package_train", "PascalVOC_train", "Pistol_train", 
                "Pothole_train", "Raccoon_train", "Shellfish_train", "Thermal_train", "Vehicle_train"
            ]:
                img_dir = try_to_find(attrs["img_dir"], return_dir=True)
                ann_dir = try_to_find(attrs["ann_file"], return_dir=True)
                args = dict(
                ...
                return dict(
                    factory="CocoGrounding_New",  # 或者 "CocoGrounding"，取决于你的实现
                    args=args,
                )
            else:
                ann_dir = try_to_find(attrs["ann_file"], return_dir=True)
